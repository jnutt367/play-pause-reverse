...
gsap.fromTo(".text", { x: 10, y: -10, opacity: "0" }, { duration: 2, x: 200, y: -10, ease: "back(6)", ease: "elastic", backgroundColor: "grey", color: "white", padding: "20", width: "400", borderRadius: "15px", fontSize: "1.5em", opacity: "1", fontFamily: "fantasy" });